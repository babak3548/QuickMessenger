...
public class JingleSocks5Transport extends JingleTransport {
	private ir.bilgisoft.toopeto.xmpp.jingle.JingleCandidate candidate;
	...
	public JingleSocks5Transport(JingleConnection jingleConnection,
			ir.bilgisoft.toopeto.xmpp.jingle.JingleCandidate candidate) {
		...
		try {
			...
			mDigest.reset();
			this.destination = ir.bilgisoft.toopeto.utils.CryptoHelper.bytesToHex(mDigest
	...
	public void send(final ir.bilgisoft.toopeto.entities.DownloadableFile file,
	...
	public void receive(final ir.bilgisoft.toopeto.entities.DownloadableFile file,
			final ir.bilgisoft.toopeto.xmpp.jingle.OnFileTransmissionStatusChanged callback) {
		new Thread(new Runnable() {
	...
	public boolean isProxy() {
		return this.candidate.getType() == ir.bilgisoft.toopeto.xmpp.jingle.JingleCandidate.TYPE_PROXY;
	}
	...
	public ir.bilgisoft.toopeto.xmpp.jingle.JingleCandidate getCandidate() {
