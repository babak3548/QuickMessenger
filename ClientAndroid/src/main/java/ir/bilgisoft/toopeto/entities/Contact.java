...
public class Contact implements ir.bilgisoft.toopeto.entities.ListItem, ir.bilgisoft.toopeto.entities.Blockable {
	...
	protected ir.bilgisoft.toopeto.entities.Presences presences = new ir.bilgisoft.toopeto.entities.Presences();
	protected ir.bilgisoft.toopeto.entities.Account account;
	...
	public static Contact fromCursor(final Cursor cursor) {
		...
		final ir.bilgisoft.toopeto.xmpp.jid.Jid jid;
		try {
			jid = ir.bilgisoft.toopeto.xmpp.jid.Jid.fromString(cursor.getString(cursor.getColumnIndex(JID)));
	...
	public Jid getJid() {
        try {
            Jid jidResult=  Jid.fromParts(jid,Jid.constantDomainpart,"");
            return jidResult;
        }
	...
	public List<Tag> getTags() {
		...
		switch (getMostAvailableStatus()) {
			...
			case ir.bilgisoft.toopeto.entities.Presences.ONLINE:
				tags.add(new Tag("online", 0xff259b24));
				break;
			case ir.bilgisoft.toopeto.entities.Presences.AWAY:
				tags.add(new Tag("away", 0xffff9800));
				break;
			case ir.bilgisoft.toopeto.entities.Presences.XA:
				tags.add(new Tag("not available", 0xffe51c23));
				break;
			case ir.bilgisoft.toopeto.entities.Presences.DND:
	...
	public void setAccount(ir.bilgisoft.toopeto.entities.Account account) {
		this.account = account;
		this.accountUuid = account.getUuid();
	}

	public ir.bilgisoft.toopeto.entities.Presences getPresences() {
		return this.presences;
	}

	public void setPresences(ir.bilgisoft.toopeto.entities.Presences pres) {
		this.presences = pres;
	}
	...
	public void parseSubscriptionFromElement(ir.bilgisoft.toopeto.xml.Element item) {
	...
	public void parseGroupsFromElement(ir.bilgisoft.toopeto.xml.Element item) {
		this.groups = new JSONArray();
		for (ir.bilgisoft.toopeto.xml.Element element : item.getChildren()) {
	...
	public ir.bilgisoft.toopeto.xml.Element asElement() {
	...
	@Override
	public int compareTo(final ir.bilgisoft.toopeto.entities.ListItem another) {
