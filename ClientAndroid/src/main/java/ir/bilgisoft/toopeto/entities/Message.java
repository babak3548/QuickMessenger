...
public class Message extends ir.bilgisoft.toopeto.entities.AbstractEntity {
	...
	public Message(Conversation conversation, String body, int encryption, int status) {
		this(java.util.UUID.randomUUID().toString(),
				...
				conversation.getJid() == null ? null : conversation.getJid(),
				null,
				body,
		...
		try {
			...
			if (extensionParts.length == 2
				...
				return true;
					...
					&& Arrays.asList(ir.bilgisoft.toopeto.entities.Downloadable.VALID_IMAGE_EXTENSIONS).contains(
