...
public abstract class SaslMechanism {
	...
	final protected ir.bilgisoft.toopeto.xml.TagWriter tagWriter;
	final protected ir.bilgisoft.toopeto.entities.Account account;
	...
	public SaslMechanism(final ir.bilgisoft.toopeto.xml.TagWriter tagWriter, final ir.bilgisoft.toopeto.entities.Account account, final SecureRandom rng) {
