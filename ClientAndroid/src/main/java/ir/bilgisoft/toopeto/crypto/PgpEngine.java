...
import ir.bilgisoft.toopeto.entities.DownloadableFile;
...
public class PgpEngine {
	...
	public PgpEngine(OpenPgpApi api, ir.bilgisoft.toopeto.services.XmppConnectionService service) {
		this.api = api;
		this.mXmppConnectionService = service;
	}

	public void decrypt(final ir.bilgisoft.toopeto.entities.Message message,
		...
		if (message.getType() == ir.bilgisoft.toopeto.entities.Message.TYPE_TEXT) {
			...
			try {
				final ir.bilgisoft.toopeto.entities.DownloadableFile inputFile = this.mXmppConnectionService
						.getFileBackend().getFile(message, false);
				final ir.bilgisoft.toopeto.entities.DownloadableFile outputFile = this.mXmppConnectionService
	...
	public void encrypt(final ir.bilgisoft.toopeto.entities.Message message,
			final ir.bilgisoft.toopeto.ui.UiCallback<ir.bilgisoft.toopeto.entities.Message> callback) {

		Intent params = new Intent();
		params.setAction(OpenPgpApi.ACTION_ENCRYPT);
		if (message.getConversation().getMode() == ir.bilgisoft.toopeto.entities.Conversation.MODE_SINGLE) {
	...
	public void hasKey(final ir.bilgisoft.toopeto.entities.Contact contact, final ir.bilgisoft.toopeto.ui.UiCallback<ir.bilgisoft.toopeto.entities.Contact> callback) {
		Intent params = new Intent();
	...
	public PendingIntent getIntentForKey(ir.bilgisoft.toopeto.entities.Contact contact) {
		Intent params = new Intent();
		params.setAction(OpenPgpApi.ACTION_GET_KEY);
		params.putExtra(OpenPgpApi.EXTRA_KEY_ID, contact.getPgpKeyId());
		params.putExtra(OpenPgpApi.EXTRA_ACCOUNT_NAME, contact.getAccount()
	...
	public PendingIntent getIntentForKey(ir.bilgisoft.toopeto.entities.Account account, long pgpKeyId) {
		Intent params = new Intent();
		params.setAction(OpenPgpApi.ACTION_GET_KEY);
