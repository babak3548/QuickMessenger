...
public class PhoneHelper {
	...
	public static void loadPhoneContacts(Context context,final List<Bundle> phoneContacts, final ir.bilgisoft.toopeto.utils.OnPhoneContactsLoadedListener listener) {
