...
import ir.bilgisoft.toopeto.ui.adapter.ConversationAdapter;
...
public class ShareWithActivity extends XmppActivity {
	...
	private List<ir.bilgisoft.toopeto.entities.Conversation> mConversations = new ArrayList<>();

	private ir.bilgisoft.toopeto.ui.UiCallback<ir.bilgisoft.toopeto.entities.Message> attachFileCallback = new UiCallback<Message>() {

		@Override
		public void userInputRequried(PendingIntent pi, ir.bilgisoft.toopeto.entities.Message object) {
		...
		@Override
		public void error(int errorCode, ir.bilgisoft.toopeto.entities.Message object) {
			// TODO Auto-generated method stub
	...
	protected void onActivityResult(int requestCode, int resultCode,
		...
		if (requestCode == REQUEST_START_NEW_CONVERSATION
			...
			Log.d(ir.bilgisoft.toopeto.Config.LOGTAG, "contact: " + share.contact + " account:"
					+ share.account);
		}
