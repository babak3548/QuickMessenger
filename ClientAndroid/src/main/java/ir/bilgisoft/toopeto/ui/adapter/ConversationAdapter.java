...
import ir.bilgisoft.toopeto.ui.XmppActivity;
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (message.getType() == Message.TYPE_IMAGE || message.getType() == Message.TYPE_FILE
			...
			if (d != null) {
				...
				} else if (d.getStatus() == ir.bilgisoft.toopeto.entities.Downloadable.STATUS_DOWNLOADING) {
			...
			} else if (message.getType() == ir.bilgisoft.toopeto.entities.Message.TYPE_FILE && message.getImageParams().width <= 0) {
			...
			if ((message.getEncryption() != ir.bilgisoft.toopeto.entities.Message.ENCRYPTION_PGP)
					&& (message.getEncryption() != ir.bilgisoft.toopeto.entities.Message.ENCRYPTION_DECRYPTION_FAILED)) {
		...
		mTimestamp.setText(ir.bilgisoft.toopeto.utils.UIHelper.readableTimeDifference(getContext(),
